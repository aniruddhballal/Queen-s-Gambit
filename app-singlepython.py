...
def upload_file():
    ...
    if request.method == 'POST':
        ...
        if uploaded_file.filename != '':
            ...
            # END TIMING - File ready for download
            ...
            print(f"📦 Input file: {uploaded_file.filename}")
...
def decrypt_file():
    # START TIMING - User clicked decrypt button
    ...
    # END TIMING - File decrypted and ready
