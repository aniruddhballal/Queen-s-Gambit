...
# Read the doubly encrypted file
with open('double_encrypted.pgn', 'rb') as f:
    double_encrypted_pgn = f.read()

print("PGN file successfully encrypted with AES and DES.")

decrypt_second = des_decrypt(double_encrypted_pgn, des_key)
decrypt_first = aes_decrypt(decrypt_second, aes_key)
with open('double_decrypted.pgn', 'wb') as f:
    f.write(decrypt_first)
print("Double encrypted PGN file successfully double decrypted.")
'''